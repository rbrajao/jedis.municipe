...
class MunicipesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create municipe" do
    assert_difference("Municipe.count") do
      post municipes_url, params: { municipe: { birthday: @municipe.birthday, cns: @municipe.cns, country_code: @municipe.country_code, cpf: @municipe.cpf, email: @municipe.email, mobile: @municipe.mobile, name: @municipe.name, status: @municipe.status } }
    end
  ...
  test "should update municipe" do
    patch municipe_url(@municipe), params: { municipe: { birthday: @municipe.birthday, cns: @municipe.cns, country_code: @municipe.country_code, cpf: @municipe.cpf, email: @municipe.email, mobile: @municipe.mobile, name: @municipe.name, status: @municipe.status } }
